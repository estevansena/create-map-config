<template>
  <div class="form-wrapper">
    <header class="form-header">
      <h1 class="header-form-title">CONFIGURAÇÕES CIDADE</h1>
    </header>
...
export default {
  ...
  data() {
    return {
      storageKey: 'form_cidade_config',
      storageKeyAlertas: 'alertas_cidade_config',
      form: this.loadFormData('form_cidade_config'),
      alertas: []
    };
  },
  watch: {
