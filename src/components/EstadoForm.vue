    <template>
        ...
        <header class="form-header">
            <h1 class="header-form-title">CONFIGURAÇÕES ESTADO</h1>
        </header>
 ...
 import { saveToStorage, loadFromStorage } from '../utils/storage';
    ...
    export default {
        ...
        data() {
        return {
            storageKey: 'form_estado_config',
            storageKeyAlertas: 'alertas_estado_config',
            form: this.loadFormData('form_estado_config'),
            alertas: []
        };
        },
        watch: {
