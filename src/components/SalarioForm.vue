<template>
    ...
    <header class="form-header">
        <h1 class="header-form-title">CONFIGURAÇÕES SALÁRIO</h1>
...
export default {
    ...
    data() {
    return {
        storageKey: 'form_salario_config',
        storageKeyAlertas: 'alertas_salario_config',
        form: this.loadFormData('form_salario_config'),
        alertas: []
    };
    },
    watch: {
