<template>
  <div class="form-wrapper">
    <header class="form-header">
      <h1 class="header-form-title">CONFIGURAÇÕES TÍTULO</h1>
    </header>

    <div class="form-container">
      <div class="form-inputs">
        <button :class="{ active: form.bancoCurriculos }" @click="toggleField('bancoCurriculos')">
...
export default {
  ...
  data() {
    return {
      storageKey: 'form_titulo_config',
      storageKeyAlertas: 'alertas_titulo_config',
      form: this.loadFormData('form_titulo_config'),
      alertas: []
    };
  },
  watch: {
  ...
  methods: {
    ...
    emitUpdate() {
      this.$emit("updateTitulo", {
        ...
        bancoCurriculos: this.form.bancoCurriculos,
