<template>
    ...
    <header class="form-header">
        <h1 class="header-form-title">CONFIGURAÇÕES ANÚNCIOS SITE</h1>
    </header>
...
export default {
    emits: ['updateTotalAnunciosSite'],
    data() {
    return {
        storageKey: 'form_totalAnunciosSite_config',
        storageKeyAlertas: 'alertas_totalAnunciosSite_config',
        form: this.loadFormData('form_totalAnunciosSite_config'),
        alertas: []
    };
    },
    watch: {
    ...
    emitUpdate() {
        this.$emit("updateTotalAnunciosSite", {
