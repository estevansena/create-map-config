<template>
  ...
  <header class="form-header">
      <h1 class="header-form-title">CONFIGURAÇÕES TOTAL VAGAS</h1>
  </header>
...
export default {
  emits: ['updateTotalVagas'],
  data() {
  return {
      storageKey: 'form_totalVagas_config',
      storageKeyAlertas: 'alertas_totalVagas_config',
      form: this.loadFormData('form_totalVagas_config'),
      alertas: []
  };
  },
  watch: {
