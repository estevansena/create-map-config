<template>
  ...
  <header class="form-header">
      <h1 class="header-form-title">CONFIGURAÇÕES TOTAL VAGAS SITE</h1>
  </header>
...
export default {
  emits: ['updateTotalVagasSite'],
  data() {
  return {
      storageKey: 'form_totalVagasSite_config',
      storageKeyAlertas: 'alertas_totalVagasSite_config',
      form: this.loadFormData('form_totalVagasSite_config'),
      alertas: []
  };
  },
  watch: {
  ...
  emitUpdate() {
      this.$emit("updateTotalVagasSite", {
