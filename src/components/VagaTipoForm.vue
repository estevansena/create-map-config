<template>
    ...
    <header class="form-header">
        <h1 class="header-form-title">CONFIGURAÇÕES VAGA TIPO</h1>
    </header>
...
export default {
    emits: ['updateVagaTipo'],
    data() {
    return {
        storageKey: 'form_vagaTipo_config',
        storageKeyAlertas: 'alertas_vagaTipo_config',
        form: this.loadFormData('form_vagaTipo_config'),
        alertas: []
    };
    },
    watch: {
